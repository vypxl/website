...
if (process.isClient)
    import('cookieconsent/build/cookieconsent.min.js').then(initCookieConsent)
...
function initCookieConsent() {
    window.cookieconsent.initialise({
        ...
        content: {
            message:
                'This website uses cookies to improve your browsing experience. To achieve that, we collect usage data and share it with analytics partners such as Google.',
        },
        theme: 'classic',
