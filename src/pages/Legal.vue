<template>
    <Layout>
        <p>
            On this page, you can find the Disclaimer, Privacy Policy &amp;
            Cookie Policy
        </p>
        ...
        <p>
            ...
            Disclaimer sets forth the general guidelines, terms and conditions
            of your use of the
            <a target="_blank" rel="nofollow" href="https://vypxl.io"
                >vypxl.io</a
            >
        ...
        <p>
            ...
            people, institutions or organizations that the owner may or may not
            be associated with in professional or personal capacity unless
        ...
        <p>
            ...
            electronic or another form or inclusion of any part of the Website
            in another website by embedding, framing or otherwise without the
            express permission of Website Operator is prohibited. If you want to
            use any of the available content, please contact me. All code
            snippets shown on this website are available to the public domain.
        </p>
        ...
        <p>
            ...
            In no event will Website Operator be liable to you or anyone else
            for any decision made or action taken in reliance on the information
            on the Website or for any consequential, special or similar damages,
            even if advised of the possibility of such damages. Furthermore,
            information contained on the Website and any pages linked to and
            from it are subject to change at any time and without warning.
        </p>
        <p>
            We reserve the right to modify this Disclaimer relating to the
            Website, products or services at any time, effective upon posting of
            an updated version of this Disclaimer on the Website. When we do we
            ...
            <a
                ...
                href="https://www.websitepolicies.com/blog/sample-disclaimer-template"
                >WebsitePolicies</a
            >.
        </p>
        ...
        <p>
            ...
            bound by this Disclaimer. If you do not agree to abide by the terms
            of this Disclaimer, you are not authorized to use or access the
            Website.
        </p>
        <h2>Contacting us</h2>
        <p>
        ...
        <p>This document was last updated on May 1, 2020</p>
        ...
        <p>
            The collection of information is done via Google Analytics. You can
            find their Terms of Service
            <a
        ...
        <p>
            ...
            information may include personal details such as name, country of
            residence, etc.
        </p>
        <p>
        ...
        <p>
            Any requests to exercise User rights can be directed to Website
            ...
            by Website Operator as early as possible.
        </p>
        ...
        <p>
            ...
            provided Personal Information to us through our Website or Service,
            please contact us. You must also be at least 16 years of age to
            consent to the processing of your Personal Information in your
        ...
        <p>
            ...
            <a target="_blank" href="https://www.cookiesandyou.com">
                cookiesandyou.com
            </a>
        </p>
        ...
        <p>
            ...
            you regarding accepting or declining the use of cookies.
        </p>
        ...
        <p>
            ...
            >
            <br />
            If you wish to reset your cookie consent status, click
            <span
...
export default {
    methods: {
        resetCookies() {
            document.cookie =
                "cookieconsent_status=''; expires = Thu, 01 Jan 1970 00:00:00 GMT"
